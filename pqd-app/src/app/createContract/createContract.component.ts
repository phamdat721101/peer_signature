...
export class createContractComponent implements OnInit {
  ...
  docHash = new FormControl('', Validators.required);
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: 'org.example.biznet.createContract',
      'docId': this.docId.value,
      'docHash': this.docHash.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.docHash) {
        formObject.docHash = result.docHash;
      } else {
        formObject.docHash = null;
      }
