...
import { signContract } from '../org.example.biznet';
import 'rxjs/Rx';
...
export class signContractService {
  ...
  private NAMESPACE = 'signContract';

  constructor(private dataService: DataService<signContract>) {
  };

  public getAll(): Observable<signContract[]> {
